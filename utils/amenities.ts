...
export const amenities: Amenity[] = [
  { name: "unlimited cloud storage", icon: FiCloud, selected: true },
  { name: "VIP parking for squirrels", icon: FiTruck, selected: true },
  { name: "self-lighting fire pit", icon: FiZap, selected: true },
  {
    name: "bbq grill with a masterchef diploma",
    icon: FiWind,
    selected: true,
  },
  { name: "outdoor furniture (tree stumps)", icon: FiSun, selected: true },
  { name: "private bathroom (bushes nearby)", icon: FiCoffee, selected: true },
...
export const conservativeAmenities: Amenity[] = [
  { name: "cloud storage", icon: FiCloud, selected: true },
  { name: "parking", icon: FiTruck, selected: true },
  { name: "fire pit", icon: FiZap, selected: true },
  { name: "bbq grill", icon: FiWind, selected: true },
  { name: "outdoor furniture", icon: FiSun, selected: true },
  { name: "private bathroom", icon: FiCoffee, selected: true },
