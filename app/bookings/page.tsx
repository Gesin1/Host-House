...
async function BookingsPage() {
  ...
  return (
    <div className="mt-16">
      ...
      <Table>
        <TableCaption>List of your recent booking</TableCaption>
        <TableHeader>
          <TableRow>
        ...
        <TableBody>
          {bookings.map((booking) => {
            const { id, orderTotal, checkIn, checkOut, totalNights } = booking;
            const { id: propertyId, country, name } = booking.property;
